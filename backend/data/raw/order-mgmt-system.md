# Order Management System (OrderSys)

## **Common Navigation Menu**
Provides navigation for whole system.
...
A collapsible vertical menu on the left side provides access to various system modules:

* **Home:** Takes the user back to the main dashboard.
* **Products:** Expands to show:
  * *Product list* — current screen.
  * *Price list* — for viewing and editing product pricing.
* **Orders:** Allows navigation to order creation and management sections.
* **Vendors:** Contains vendor-related management options.
* **Sales:** Provides access to sales records and reports.
* **Invoices:** Links to invoice management for orders and transactions.
